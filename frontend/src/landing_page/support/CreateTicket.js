     ...
     <div className='container'>
        <div className='row p-5 mt-5 mb-5'>
         ...
         <div className='col-4 p-5 mt-2 mb-2'>
            ...
            <h4><a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Online Account</a><br />
                <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Opening offline Account Opening</a><br />
                ...
                <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Getting Started</a></h4>

        </div>
        <div className='col-4 p-5 mt-2 mb-2'>
            <h4 className=''><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account </h4>
            <h4><a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Login Credentials</a><br />
        ...
        <div className='col-4 p-5 mt-2 mb-2'>
            ...
            <h4><a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Margin/leverage,product and order types</a><br />
                ...
                <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>GTT</a></h4>

        </div>
        <div className='col-4 p-5 mt-2 mb-2'>
            <h4 className=''><i class="fa fa-credit-card" aria-hidden="true"></i>Funds </h4>
            <h4><a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Adding Funds</a><br />
        ...
        <div className='col-4 p-5 mt-2 mb-2'>
            ...
            <h4><a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Reports</a><br />
        ...
        <div className='col-4 p-5 mt-2 mb-2'>
            ...
            <h4><a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Understanding Mutual Funds</a><br />
                ...
                <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Government Securities</a></h4>
